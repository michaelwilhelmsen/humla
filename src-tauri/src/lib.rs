    ...
    F: FnOnce(sync::SyncContext) -> Arc<dyn sync::SyncObserver> + Send + 'static,
{
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::notes_with_recordings,
            ...
            commands::chat_set_client_filter,
            commands::chat_get_client_filter,
            commands::chat_set_speaker_filter,
            commands::chat_get_speaker_filter,
            commands::chat_usage,
